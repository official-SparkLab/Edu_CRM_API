...
router.post('/',authenticate, upload.none(), paymentCourseValidator.fetchPaymentCourseByAdmissionId, validate, paymentCourseController.getPaymentCourseByAdmissionId);
