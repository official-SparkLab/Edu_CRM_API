...
router.post('/',authenticate, upload.none(), paymentServiceValidator.fetchPaymentServiceByAdmissionId, validate, paymentServiceController.getPaymentServiceByAdmissionId);
